 ...
 * Class Note:
 * use ViewDragHelper to process drag for views (ListView,GridView,RecyclerView)
 */
public class SwipeViewLayout extends FrameLayout {
    /**
     * support four direction drag
     */
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                l.onHandRelease(SwipeViewLayout.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(SwipeViewLayout.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(SwipeViewLayout.this);
                }
                mEventCounter = 0;
            }
    ...
    public interface OnLayout {
        void onLayout(SwipeViewLayout v);
    }
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(SwipeViewLayout.this, target == surface);
            }
            return true;
        }
    }
...
/*--------------------------3 listener set-----------------------------*/
    /**
     * swipe listener for this layout
     */
    public interface SwipeListener {
        void onStartOpen(SwipeViewLayout layout);

        void onOpen(SwipeViewLayout layout);

        void onStartClose(SwipeViewLayout layout);

        void onClose(SwipeViewLayout layout);

        void onUpdate(SwipeViewLayout layout, int leftOffset, int topOffset);

        void onHandRelease(SwipeViewLayout layout, float xvel, float yvel);
    }
    ...
    public interface DoubleClickListener {
        void onDoubleClick(SwipeViewLayout layout, boolean surface);
    }
